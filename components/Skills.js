...
export default function Skills() {
  ...
  const skillGroups = [
    {
      title: "Frontend",
      icon: <span className="material-symbols-outlined text-primary">developer_mode_tv</span>,
      skills: [
    ...
    {
      title: "Backend",
      icon: <span className="material-symbols-outlined text-secondary">database</span>,
      skills: [
    ...
    {
      title: "Tools",
      icon: <span className="material-symbols-outlined text-tertiary">construction</span>,
      skills: [
  ...
  return (
    <section id="skills" ref={sectionRef} className="py-20 space-y-12">
      <div className="text-center">
        <h2 className="text-display text-foreground">Technical Arsenal</h2>
      </div>
        ...
        {skillGroups.map((group, idx) => (
          ...
          >
            ...
            <div className="flex flex-wrap gap-2 pt-4 border-t border-primary/10">
              {group.tags.map((tag) => (
                <span key={tag} className="px-3 py-1 bg-primary-container/20 text-foreground text-[10px] uppercase tracking-wider font-bold rounded-full border border-primary/10">
                  {tag}
                </span>
              ))}
            </div>
